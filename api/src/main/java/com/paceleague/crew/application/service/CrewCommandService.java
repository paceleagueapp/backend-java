...
import com.paceleague.crew.application.port.in.CrewCommandUseCase;
...
import com.paceleague.crew.domain.policy.CrewNamePolicy;
...
@Transactional
public class CrewCommandService implements CrewCommandUseCase {
    ...
    private Crew getCrew(Long crewSno) {
        return crewRepositoryPort.findBySno(crewSno).orElseThrow(CrewCommandService::crewNotFound);
    }
