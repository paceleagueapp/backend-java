...
var TERRITORY_STRINGS = {
  ko: { navCommunity: '커뮤니티', navLandit: '랜드잇', navCrew: '크루', mapTitle: '랜드잇', territoryZoomIn: '지도를 더 확대하면 점령된 땅이 표시됩니다', territoryOwner: '점령자', territoryHp: '체력', territoryMine: '내 땅', territoryLoadFailed: '땅 정보를 불러오지 못했습니다', territoryLocating: '현재 위치를 찾는 중...', territoryRanking: '땅따먹기 랭킹', territoryRankArea: '총 면적', territoryRankPlots: '땅', territoryRankEmpty: '아직 점령된 땅이 없습니다' },
  en: { navCommunity: 'Community', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Zoom in to see claimed territories', territoryOwner: 'Owner', territoryHp: 'HP', territoryMine: 'My territory', territoryLoadFailed: 'Failed to load territories', territoryLocating: 'Finding your location...', territoryRanking: 'Land Ranking', territoryRankArea: 'Total area', territoryRankPlots: 'plots', territoryRankEmpty: 'No territories claimed yet' },
  ja: { navCommunity: 'コミュニティ', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: '地図を拡大すると占領された土地が表示されます', territoryOwner: '占領者', territoryHp: '体力', territoryMine: '自分の土地', territoryLoadFailed: '土地情報を読み込めませんでした', territoryLocating: '現在地を取得中...', territoryRanking: 'ランドランキング', territoryRankArea: '総面積', territoryRankPlots: '土地', territoryRankEmpty: 'まだ占領された土地がありません' },
  zh: { navCommunity: '社区', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: '放大地图即可查看已占领的领地', territoryOwner: '占领者', territoryHp: '生命值', territoryMine: '我的领地', territoryLoadFailed: '加载领地信息失败', territoryLocating: '正在获取当前位置...', territoryRanking: '领地排行', territoryRankArea: '总面积', territoryRankPlots: '块', territoryRankEmpty: '还没有被占领的领地' },
  es: { navCommunity: 'Comunidad', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Acerca el mapa para ver los territorios conquistados', territoryOwner: 'Dueño', territoryHp: 'PV', territoryMine: 'Mi territorio', territoryLoadFailed: 'Error al cargar los territorios', territoryLocating: 'Buscando tu ubicación...', territoryRanking: 'Ranking de territorios', territoryRankArea: 'Área total', territoryRankPlots: 'parcelas', territoryRankEmpty: 'Aún no hay territorios conquistados' },
  fr: { navCommunity: 'Communauté', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Zoomez pour voir les territoires conquis', territoryOwner: 'Propriétaire', territoryHp: 'PV', territoryMine: 'Mon territoire', territoryLoadFailed: 'Échec du chargement des territoires', territoryLocating: 'Recherche de votre position...', territoryRanking: 'Classement des territoires', territoryRankArea: 'Surface totale', territoryRankPlots: 'parcelles', territoryRankEmpty: 'Aucun territoire conquis pour l’instant' },
  de: { navCommunity: 'Community', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Zoome hinein, um eroberte Gebiete zu sehen', territoryOwner: 'Besitzer', territoryHp: 'TP', territoryMine: 'Mein Gebiet', territoryLoadFailed: 'Gebiete konnten nicht geladen werden', territoryLocating: 'Standort wird ermittelt...', territoryRanking: 'Gebiets-Rangliste', territoryRankArea: 'Gesamtfläche', territoryRankPlots: 'Gebiete', territoryRankEmpty: 'Noch keine Gebiete erobert' },
  pt: { navCommunity: 'Comunidade', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Aproxime o mapa para ver os territórios conquistados', territoryOwner: 'Dono', territoryHp: 'PV', territoryMine: 'Meu território', territoryLoadFailed: 'Falha ao carregar os territórios', territoryLocating: 'Localizando você...', territoryRanking: 'Ranking de territórios', territoryRankArea: 'Área total', territoryRankPlots: 'parcelas', territoryRankEmpty: 'Ainda não há territórios conquistados' },
  vi: { navCommunity: 'Cộng đồng', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Phóng to bản đồ để xem các vùng đất đã chiếm', territoryOwner: 'Chủ sở hữu', territoryHp: 'HP', territoryMine: 'Đất của tôi', territoryLoadFailed: 'Không tải được thông tin vùng đất', territoryLocating: 'Đang tìm vị trí của bạn...', territoryRanking: 'Bảng xếp hạng đất', territoryRankArea: 'Tổng diện tích', territoryRankPlots: 'mảnh', territoryRankEmpty: 'Chưa có vùng đất nào bị chiếm' },
  th: { navCommunity: 'ชุมชน', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'ซูมเข้าเพื่อดูพื้นที่ที่ถูกยึดครอง', territoryOwner: 'ผู้ยึดครอง', territoryHp: 'พลังชีวิต', territoryMine: 'พื้นที่ของฉัน', territoryLoadFailed: 'โหลดข้อมูลพื้นที่ไม่สำเร็จ', territoryLocating: 'กำลังค้นหาตำแหน่งของคุณ...', territoryRanking: 'อันดับพื้นที่', territoryRankArea: 'พื้นที่รวม', territoryRankPlots: 'แปลง', territoryRankEmpty: 'ยังไม่มีพื้นที่ที่ถูกยึดครอง' }
};
