...
var TERRITORY_STRINGS = {
  ko: { navCommunity: '커뮤니티', navLandit: '랜드잇', navCrew: '크루', mapTitle: '랜드잇', territoryZoomIn: '지도를 더 확대하면 점령된 땅이 표시됩니다', territoryOwner: '점령자', territoryHp: '체력', territoryMine: '내 땅', territoryLoadFailed: '땅 정보를 불러오지 못했습니다', territoryLocating: '현재 위치를 찾는 중...', territoryRanking: '랜드잇 랭킹', territoryRankArea: '총 면적', territoryRankPlots: '땅', territoryRankEmpty: '아직 점령된 땅이 없습니다' },
  ...
  zh: { navCommunity: '社区', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: '放大地图即可查看已占领的领地', territoryOwner: '占领者', territoryHp: '生命值', territoryMine: '我的领地', territoryLoadFailed: '加载领地信息失败', territoryLocating: '正在获取当前位置...', territoryRanking: 'Landeat 排行', territoryRankArea: '总面积', territoryRankPlots: '块', territoryRankEmpty: '还没有被占领的领地' },
  es: { navCommunity: 'Comunidad', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Acerca el mapa para ver los territorios conquistados', territoryOwner: 'Dueño', territoryHp: 'PV', territoryMine: 'Mi territorio', territoryLoadFailed: 'Error al cargar los territorios', territoryLocating: 'Buscando tu ubicación...', territoryRanking: 'Ranking de Landeat', territoryRankArea: 'Área total', territoryRankPlots: 'parcelas', territoryRankEmpty: 'Aún no hay territorios conquistados' },
  fr: { navCommunity: 'Communauté', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Zoomez pour voir les territoires conquis', territoryOwner: 'Propriétaire', territoryHp: 'PV', territoryMine: 'Mon territoire', territoryLoadFailed: 'Échec du chargement des territoires', territoryLocating: 'Recherche de votre position...', territoryRanking: 'Classement Landeat', territoryRankArea: 'Surface totale', territoryRankPlots: 'parcelles', territoryRankEmpty: 'Aucun territoire conquis pour l’instant' },
  ...
  vi: { navCommunity: 'Cộng đồng', navLandit: 'Landeat', navCrew: 'Crew', mapTitle: 'Landeat', territoryZoomIn: 'Phóng to bản đồ để xem các vùng đất đã chiếm', territoryOwner: 'Chủ sở hữu', territoryHp: 'HP', territoryMine: 'Đất của tôi', territoryLoadFailed: 'Không tải được thông tin vùng đất', territoryLocating: 'Đang tìm vị trí của bạn...', territoryRanking: 'Bảng xếp hạng Landeat', territoryRankArea: 'Tổng diện tích', territoryRankPlots: 'mảnh', territoryRankEmpty: 'Chưa có vùng đất nào bị chiếm' },
